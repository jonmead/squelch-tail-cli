 ...
 */
export function printBanner(port=null) {
  ...
  let myfg = '\x1b[38;5;0m';
  let mybg = '\x1b[48;5;220m';
  ...
  console.log(`${T2}${line}${R}`);
  console.log(`  ${A}${r1}                        ${R}`);
  console.log(`  ${A}${r2}${t24}${R}    ${W}SQUELCH${R}`);
  console.log(`  ${A}${myfg}${mybg}     \u001b[3mcli-client      ${R}${t3}${R}    ${A}TAIL${R}`);
